...
const componentFiles = async (name, scaffoldPath = '') => {
  ...
  const columns = (0, _map.default)(_context4 = (0, _filter.default)(_context5 = model.fields).call(_context5, field => field.kind !== 'object')).call(_context4, column => {
    var _componentMetadata$co, _componentMetadata$co2, _componentMetadata$co3, _componentMetadata$co4, _componentMetadata$co5;

    return { ...column,
      label: (0, _humanizeString.default)(column.name),
      component: ((_componentMetadata$co = componentMetadata[column.type]) === null || _componentMetadata$co === void 0 ? void 0 : _componentMetadata$co.name) || componentMetadata.String.name,
      defaultProp: ((_componentMetadata$co2 = componentMetadata[column.type]) === null || _componentMetadata$co2 === void 0 ? void 0 : _componentMetadata$co2.defaultProp) || componentMetadata.String.defaultProp,
      validation: (_componentMetadata$co3 = (_componentMetadata$co4 = componentMetadata[column.type]) === null || _componentMetadata$co4 === void 0 ? void 0 : _componentMetadata$co4.validation) !== null && _componentMetadata$co3 !== void 0 ? _componentMetadata$co3 : componentMetadata.String.validation,
      displayFunction: ((_componentMetadata$co5 = componentMetadata[column.type]) === null || _componentMetadata$co5 === void 0 ? void 0 : _componentMetadata$co5.displayFunction) || componentMetadata.String.displayFunction
    };
  });
