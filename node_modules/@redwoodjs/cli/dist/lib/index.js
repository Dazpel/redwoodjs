...
exports.getDefaultArgs = exports.runCommandTask = exports.removeRoutesFromRouterTask = exports.addRoutesToRouterTask = exports.cleanupEmptyDirsTask = exports.deleteFilesTask = exports.writeFilesTask = exports.transformTSToJS = exports.prettierOptions = exports.getPaths = exports.bytes = exports.writeFile = exports.deleteFile = exports.readFile = exports.prettify = exports.generateTemplate = exports.templateRoot = exports.nameVariants = exports.getSchemaDefinitions = exports.getEnum = exports.getSchema = exports.asyncForEach = void 0;
...
const getDefaultArgs = builder => {
  ...
  return (0, _reduce.default)(_context7 = (0, _entries.default)(builder)).call(_context7, (agg, [k, v]) => {
    agg[k] = v.default;
    return agg;
  }, {});
};
