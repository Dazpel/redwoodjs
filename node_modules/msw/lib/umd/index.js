(function (global, factory) {
  ...
  (global = global || self, factory(global.MockServiceWorker = {}));
  ...
  ***************************************************************************** */
  ...
  const getWorkerInstance = (url, options) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const [, mockRegistrations] = yield lib_1$1(() => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const [, existingRegistration] = yield lib_1$1(() => {
      ...
      const [error, instance] = yield lib_1$1(() => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const createStart = (context) => {
      ...
      return function start(options) {
          ...
          const startWorkerInstance = () => __awaiter(this, void 0, void 0, function* () {
              ...
              const [, instance] = yield lib_1$1(() => getWorkerInstance(resolvedOptions.serviceWorker.url, resolvedOptions.serviceWorker.options));
              if (!instance) {
                  return null;
              }
              ...
              const [integrityError] = yield lib_1$1(() => requestIntegrityCheck(worker));
              if (integrityError) {
                  console.error(`\
...
If this message still persists after updating, please report an issue: https://github.com/open-draft/msw/issues\
      `);
              ...
              const [activationError] = yield lib_1$1(() => activateMocking(worker, options));
              if (activationError) {
  ...
  unwrapExports(getCleanUrl_1);
  var getCleanUrl_2 = getCleanUrl_1.getCleanUrl;
      ...
      return (mask, resolver) => {
          return {
              predicate(req) {
                  ...
                  const cleanUrl = getCleanUrl_2(req.url);
              ...
              getPublicRequest(req) {
                  ...
                  const params = (mask &&
                      match(resolveRelativeUrl(mask), getCleanUrl_2(req.url)).params) ||
                      {};
              ...
              log(req, res, handler) {
                  ...
                  console.groupCollapsed('[MSW] %s %s %s (%c%s%c)', getTimestamp(), req.method, publicUrl, styleStatusCode(res.status), res.status, 'color:inherit');
      ...
      return (expectedOperation, resolver) => {
          return {
              ...
              log(req, res, handler, parsed) {
                  ...
                  const loggedRequest = prepareRequest(req);
                  const loggedResponse = prepareResponse(res);
                  console.groupCollapsed('[MSW] %s %s (%c%s%c)', getTimestamp(), operationName, styleStatusCode(res.status), res.status, 'color:inherit');
                  console.log('Request:', loggedRequest);
                  console.log('Handler:', {
                      operationType,
  ...
  exports.composeMocks = composeMocks;
