...
const extractExperimentalFeatures_1 = require("./utils/extractExperimentalFeatures");
const mapExperimentalFeatures_1 = require("./utils/mapExperimentalFeatures");
...
version, cliVersion, printDownloadProgress, baseDir = path_1.default.dirname(schemaPath), overrideGenerators, skipDownload, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const experimentalFeatures = extractExperimentalFeatures_1.extractExperimentalFeatures(config);
        const dmmf = yield engineCommands_1.getDMMF({
            datamodel,
            datamodelPath: schemaPath,
            prismaPath,
            enableExperimental: mapExperimentalFeatures_1.mapExperimentalFeatures(experimentalFeatures),
        });
