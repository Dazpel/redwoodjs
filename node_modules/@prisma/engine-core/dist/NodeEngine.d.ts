...
export declare class NodeEngine {
    ...
    h1Client: H1Client;
    constructor({ cwd, datamodelPath, prismaPath, generator, datasources, showColors, logLevel, logQueries, env, flags, clientVersion, enableExperimental, engineEndpoint, ...args }: EngineConfig);
    private resolveCwd;
    ...
    requestBatch<T>(queries: string[], transaction?: boolean): Promise<T>;
