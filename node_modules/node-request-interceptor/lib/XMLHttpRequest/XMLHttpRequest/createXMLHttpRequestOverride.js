...
exports.createXMLHttpRequestOverride = function (middleware, XMLHttpRequestPristine) {
    return /** @class */ (function () {
        ...
        XMLHttpRequestOverride.prototype.trigger = function (event, options) {
            debug('trigger', event);
            this.triggerReadyStateChange(options);
            var hasEvent = this._events.find(function (item) { return item.type === 'loadend'; });
            if (this.readyState === this.DONE && (this.onloadend || hasEvent)) {
                ...
                if (typeof listener !== 'undefined') {
                    listener.call(this, createEvent_1.createEvent(options, this, 'loadend'));
                }
            }
            if (this['on' + event]) {
                ;
                this['on' + event].call(this, createEvent_1.createEvent(options, this, event));
            }
            for (var _i = 0, _a = this._events; _i < _a.length; _i++) {
                var event_1 = _a[_i];
                if (event_1.type === event_1) {
                    event_1.listener.call(this, createEvent_1.createEvent(options, this, event_1));
                }
            }
            return this;
        };
        ...
        XMLHttpRequestOverride.prototype.send = function (data) {
            ...
            Promise.resolve(middleware(req, this)).then(function (mockedResponse) {
                ...
                if (mockedResponse) {
                    ...
                    originalRequest_1.open(_this.method, _this.url, _this.async, _this.user, _this.password);
                    ...
                    originalRequest_1.onabort = _this.abort;
                    originalRequest_1.onerror = _this.onerror;
                    originalRequest_1.ontimeout = _this.ontimeout;
                    originalRequest_1.onreadystatechange = _this.onreadystatechange;
