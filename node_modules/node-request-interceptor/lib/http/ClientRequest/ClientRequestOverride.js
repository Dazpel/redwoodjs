...
var normalizeHttpRequestParams_1 = require("./normalizeHttpRequestParams");
var debug = require('debug')('http:client-request');
...
function createClientRequestOverrideClass(middleware, performOriginalRequest, originalClientRequest) {
    function ClientRequestOverride() {
        ...
        this.end = function () { return __awaiter(_this, void 0, void 0, function () {
            var requestBody, requestHeaders, formattedRequest, mockedResponse, _a, headers, req, ClientRequest;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        requestBody = bodyBufferToString(Buffer.concat(requestBodyBuffer));
                        debug('request body', requestBody);
                        requestHeaders = options.headers
                            ? headers_utils_1.reduceHeadersObject(options.headers, function (headers, name, value) {
                        ...
                        return [4 /*yield*/, middleware(formattedRequest, response)];
                    case 1:
                        mockedResponse = _b.sent();
                        if (mockedResponse) {
                            debug('received mocked response:', mockedResponse);
                            // Prevent modifying an already finished response.
                            if (!response.complete) {
                                _a = mockedResponse.headers, headers = _a === void 0 ? {} : _a;
